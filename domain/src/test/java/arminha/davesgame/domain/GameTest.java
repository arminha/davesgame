...
public class GameTest {
  ...
  public void checkPlayerOnPutStone() throws Exception {
    loadHistory(game, new GameCreated(id, NAME, firstPlayerId, secondPlayerId),
        new NextStoneChoosen(id, firstPlayerId, 0));
  ...
  public void simpleWinningGame() throws Exception {
    ...
    assertHasChanges(game, is(new StonePut(id, firstPlayerId, 0, 3)), is(new Winner(id,
        firstPlayerId)));
  }
  ...
  @SafeVarargs
  protected final void assertHasChanges(AggregateRoot aggregateRoot,
      Matcher<? extends Event>... matchers) {
