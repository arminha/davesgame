...
public class GeneratorMain {
  ...
  @Option(name = "-d", aliases = "--dest-src-dir", required = true, usage = "source folder for the generated Java sources", metaVar = "DIR")
  ...
  public void doMain(String[] args) {
    ...
    try {
      ...
      System.err
          .println(" Example: java SampleMain" + parser.printExample(OptionHandlerFilter.ALL));
      return;
    }
