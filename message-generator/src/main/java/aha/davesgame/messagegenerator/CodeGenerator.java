...
public class CodeGenerator {
   ...
   */
  public void addMessage(Message message) throws JClassAlreadyExistsException,
  ...
  private class MessageGenerator {
    ...
    public MessageGenerator(Message message) throws JClassAlreadyExistsException,
    ...
    private void generateGetter(Property p) throws ClassNotFoundException {
      String getterName = "get" + p.getName().substring(0, 1).toUpperCase()
    ...
    private void generateToString() {
      ...
      JInvocation invocation = cm.ref(MoreObjects.class).staticInvoke("toStringHelper")
          .arg(_this());
      for (Property p : getProperties()) {
